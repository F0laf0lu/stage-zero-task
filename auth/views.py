...
class GithubCallBackView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({"message": "Error getting token", "error": str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
        ...
        try:
            ...
            return Response({"message": "Error getting user info","error": str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
        ...
        try:
            ...
            return Response({"message": "Error getting email", "error": str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
